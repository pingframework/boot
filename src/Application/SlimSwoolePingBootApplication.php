...
use Pingframework\Boot\Http\Server\SlimSwooleHttpRequestHandler;
...
class SlimSwoolePingBootApplication extends AbstractSwoolePingBootApplication
{
    public function __construct(
        private readonly SlimSwooleHttpRequestHandler $handler,
    ) {}
