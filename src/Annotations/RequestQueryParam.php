...
class RequestQueryParam implements RuntimeArgumentInjector
{
    ...
    public function inject(
        ...
        $value = $runtime[ServerRequestInterface::class]->getQueryParams()[$this->name ?? $rp->getName()] ?? null;
        ...
        if ($value === null) {
            if (!$rp->isOptional()) {
                throw new HttpBadRequestException(
                    ...
                    sprintf(
                        'Required query param "%s" is not present in request',
