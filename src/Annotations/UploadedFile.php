...
class UploadedFile implements RuntimeArgumentInjector
{
    ...
    public function inject(
        ...
        $value =  $request->getUploadedFiles()[$this->name ?? $rp->getName()] ?? null;
        ...
        if ($value === null) {
            if (!$rp->isOptional()) {
                throw new HttpBadRequestException(
                    ...
                    sprintf(
                        'Required uploaded file "%s" is not present in request',
