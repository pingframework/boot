 ...
 * @license   http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
#[PingBootApplication(Priority::NORMAL)]
class TestPingBootApplication3 extends AbstractPingBootApplication
{
    #[Autowired]
    public function configure(): void
    {
        $this->getApplicationContext()->set('answer', 3);
        $this->getApplicationContext()->set('answer2', 3);
    }
}