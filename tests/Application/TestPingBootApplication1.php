 ...
 * @license   http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
#[PingBootApplication(Priority::LOW)]
#[ComponentScan(['Pingframework\\Boot\\Tests'])]
#[ConfigFile([__DIR__ . '/config1.php'])]
class TestPingBootApplication1 extends AbstractPingBootApplication
{
    #[Autowired]
    public function configure(): void
    {
        $this->getApplicationContext()->set('answer', 42);
    }
}